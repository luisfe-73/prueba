      ...
      <div class="panel panel-flat">
         <div class="panel-body">
            <div class="col-sm-6 col-md-3">
               ...
               {!! Form::select('equipo_id', $relacion_nombreequipos, null, ['class' => 'select-search','placeholder' => 'selecciona...', 'disabled' => 'disabled'])!!}
               <span class="text-danger text-size-mini">{{$errors->first('equipo_id')}}</span>
            </div>
            <div class="col-sm-6 col-md-3">
               {!! Form::label('jugador_id','Nombre jugador', ['class' => 'text-blue']) !!}
               {!! Form::select('jugador_id', $relacion_jugadores, null, ['class' => 'select-search','placeholder' => 'selecciona...', 'disabled' => 'disabled'])!!}
